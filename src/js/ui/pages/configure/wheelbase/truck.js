...
module.exports = ({state, actions}) => h('svg', {
	...
	h('g', {
		...
		h('rect', {
			attrs: {
				...
				'width': (state.configure.configuration.wheelbase.length / 100).toFixed(2) // 26.729999999999997
			}
		}, [
		]),
	...
	h('g', {
		attrs: {
			...
			'transform': 'translate(' + (state.configure.configuration.wheelbase.length / 100 - 5).toFixed(2) + ',0)' // '21.229999999999997,0)'
		}
	}, [
		h('path', {
			attrs: {
	...
	h('g', {
		attrs: {
			...
			'transform': 'translate(' + (state.configure.configuration.wheelbase.length / 100 + 2).toFixed(2) + ',0)' // 28.613999999999997,0)'
		}
	}, [
		h('polygon', {
			attrs: {
